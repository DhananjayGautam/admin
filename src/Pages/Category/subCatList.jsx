...
const columns = [
  ...
  { id: 'subCatName', label: ' Sub Category Name', minWidth: 500 },
...
const SubCategoryList = () => {
  ...
  return (
    ...
    <div className='flex items-center justify-between px-2 py-0 mt-3'>
          ...
          <div className='col w-[30%] flex items-center gap-3 ml-auto justify-end'>
                  ...
                  <div className='flex items-center gap-4 w-[80px]'>
                    <div className='img w-full  overflow-hidden rounded-md group'>
                      <Link to="/product/45745">
                        <img src="/shop-illustration.webp" className='w-full group-hover:scale-105 transition-all' />
                      </Link>
                    </div>
